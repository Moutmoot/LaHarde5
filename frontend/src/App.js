...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex space-x-6">
              <a href="#accueil" className="hover:text-red-200 transition">Accueil</a>
              <a href="#club" className="hover:text-red-200 transition">Le Club</a>
              <a href="#roller-derby" className="hover:text-red-200 transition">Roller Derby</a>
              <a href="#entrainements" className="hover:text-red-200 transition">Entraînements</a>
      ...
      {/* Hero Section */}
      <section id="accueil" className="relative bg-gray-900 text-white overflow-hidden">
      ...
      <section id="roller-derby" className="py-16 bg-gray-100">
        <div className="container mx-auto px-6">
      ...
      <section id="entrainements" className="py-16 bg-white">
        <div className="container mx-auto px-6">
